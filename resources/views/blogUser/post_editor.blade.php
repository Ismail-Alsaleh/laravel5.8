...
@section('content')
        ...
        <div class="container-floid d-flex align-items-center justify-content-center bg-white-gray m-0"  style="height: 83vh;">
            ...
            <div id="postPart" class="w-75 h-100 bg-gray-white text-center shadow" style="height: 100vh;">
                ...
                <div class="px-2">
                    <!-- Making Posts -->
                    <form method="post" action="{{route('blogUser.addPost')}}" class="text-start">
                        @csrf
                    ...
                    <div class="mb-4  bg-light border-thick">
                        ...
                        <div class=" my-3 bg-light  text-start mx-2">
                            ...
                            <a class="text-decoration-none bg-moroon text-white px-2 fs-5" href="{{route('blogUser.deletePost',['post_id'=>$post->post_id])}}">Delete the post</a>    
                        </div>
                        <div class="bg-moroon">
                            <hr class="text-light">
                        ...
                        @foreach ($comments as $comment )
                            ...
                            <div id="comment" class="mx-5 mb-4 bg-light text-start w-75">
                                ...
                                @if (!$comment['accepted'])
                                    <a class="mx-5 text-decoration-none bg-moroon text-white px-2 fs-5" href="{{route('blogUser.acceptComment', ['comment_id' => $comment->comment_id])}}">Accept</a>
                                    <a class="text-decoration-none bg-moroon text-white px-3 fs-5" href="{{route('blogUser.deleteComment', ['comment_id' => $comment->comment_id])}}">Reject</a>                             
                                @endif
                        ...
                        <div id="comment" class="mx-5 mb-4 bg-light text-start w-75">
                            <div class="  d-flex align-items-center px-5">
                                ...
                                <form method="post" action="{{route('blogUser.addComment')}}" class=" w-75">
                                    @csrf
